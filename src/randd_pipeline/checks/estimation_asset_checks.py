...
try:
    ...
    def estimated_responses_non_empty(table_store: TableStoreResource):
        df, missing = read_table_for_check(table_store, refs.INTERMEDIATE_ESTIMATED_RESPONSES, check_label="non-empty check")
    ...
    def estimated_responses_required_columns(table_store: TableStoreResource):
        df, missing = read_table_for_check(table_store, refs.INTERMEDIATE_ESTIMATED_RESPONSES, check_label="required columns")
        if missing: return missing
    ...
    def estimated_responses_unique_grain(table_store: TableStoreResource):
        df, missing = read_table_for_check(table_store, refs.INTERMEDIATE_ESTIMATED_RESPONSES, check_label="unique grain")
        if missing: return missing
    ...
    def estimated_responses_weights_populated(table_store: TableStoreResource):
        df, missing = read_table_for_check(table_store, refs.INTERMEDIATE_ESTIMATED_RESPONSES, check_label="weights populated")
        if missing: return missing
    ...
    def estimated_responses_weights_positive(table_store: TableStoreResource):
        df, missing = read_table_for_check(table_store, refs.INTERMEDIATE_ESTIMATED_RESPONSES, check_label="weights positive")
        if missing: return missing
