...
try:
    ...
    def site_apportioned_responses_non_empty(table_store: TableStoreResource):
        ...
        if m: return m
        p,d=check_site_apportioned_non_empty(df); return AssetCheckResult(passed=p, description=d)
    ...
    def site_apportioned_responses_required_columns(table_store: TableStoreResource):
        ...
        if m: return m
        p,d=check_site_apportioned_required_columns(df); return AssetCheckResult(passed=p, description=d)
    ...
    def site_apportioned_responses_unique_site_grain(table_store: TableStoreResource):
        ...
        if m: return m
        p,d=check_site_apportioned_unique_site_grain(df); return AssetCheckResult(passed=p, description=d)
    ...
    def site_apportioned_responses_site_identifier_populated(table_store: TableStoreResource):
        ...
        if m: return m
        p,d=check_site_identifier_populated(df); return AssetCheckResult(passed=p, description=d)
    ...
    def site_apportioned_responses_site_proportion_populated(table_store: TableStoreResource):
        ...
        if m: return m
        p,d=check_site_proportion_populated(df); return AssetCheckResult(passed=p, description=d)
    ...
    def site_apportioned_responses_apportioned_values_non_negative(table_store: TableStoreResource):
        ...
        if m: return m
        p,d=check_apportioned_values_non_negative(df); return AssetCheckResult(passed=p, description=d)
