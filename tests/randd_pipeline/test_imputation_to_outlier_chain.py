...
def test_imputation_to_outlier_chain_runs_full_outlier_check_set(tmp_path) -> None:
    ...
    defs = dagster.Definitions(
        assets=[assets_mod.outlier_adjusted_responses],
        asset_checks=[getattr(checks_mod, check_name) for check_name in check_names],
