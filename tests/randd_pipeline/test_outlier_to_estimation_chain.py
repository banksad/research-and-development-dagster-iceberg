...
def test_outlier_to_estimation_chain_with_checks(tmp_path) -> None:
    ...
    defs = dagster.Definitions(
        ...
        asset_checks=[
            check_mod.estimated_responses_table_exists,
            check_mod.estimated_responses_non_empty,
            check_mod.estimated_responses_required_columns,
            check_mod.estimated_responses_unique_grain,
            check_mod.estimated_responses_weights_populated,
            check_mod.estimated_responses_weights_positive,
        ],
